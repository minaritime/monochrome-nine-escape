...
export const PATCH_NOTES: readonly PatchNote[] = [
  {
    ...
    date: '2026-09-15',
    intro:
      '한 판 플레이 시간이 15분이 적당하니 더 늘리지 말라는 협박을 받았습니다. 따라서 특정 난이도부터 증가하는 클리어 시간을 없애고 모두 15분으로 통일하였습니다. 이 작업에서 밸런스에 영향이 가지않도록 적의 스펙이 더 증가하고 처치 경험치가 크게 증가합니다. 또한 코인을 추가로 조정하여 코인수급을 원활하게 만들었습니다.',
    groups: [
      {
        title: '',
        items: [
          ...
          {
            title: '플레이어',
            lines: ['+ 적을 처치했을 때 얻는 경험치가 크게 증가했습니다.'],
          },
          {
            title: '적',
