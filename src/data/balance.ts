...
export const CHALLENGE_RULES = {
  ...
  shieldMarch: {
     ...
     *
     * 방패와 돌진을 1:3 으로 나눠 채웁니다. 1 + 3 마리로 시작하고, 클리어가 2분이라
     * 24번 늘어 **방패 7 · 돌진 21** 에서 끝납니다.
     *
     * ⚠ **아래 상한(10 · 30)에는 안 닿습니다.** 그 값은 클리어가 3분이던 때 맞춰
     * 둔 끝점입니다. 판을 2분으로 줄이면서 "5초마다 한 마리"라는 리듬을 그대로
     * 두기로 했으므로(2026-09-16), 짧아진 만큼 최고조도 낮아집니다. 10 · 30 을
     * 되살리려면 이 간격을 3.3 초쯤으로 줄여야 합니다
     */
    spawnStep: 5,
