...
export const CHALLENGE_RULES = {
  ...
  blackout: {
     ...
     * 추첨되는 스탯 2개와 별도입니다.
     *
     * 목표는 **1분 30초에 시작 속도(205)의 2배**입니다. 잡으러 다녀야 하는 판인데
     * 겁쟁이 상한이 늘수록 초당 찾아 잡아야 하는 마릿수가 오르므로(상한 ÷ 인내),
     * 그만큼 발을 빠르게 해서 순회가 따라가게 합니다.
     *
     * 레벨에 걸린 값이라 **시간에 정확히 맞지는 않습니다.** 경험치는 잡은 겁쟁이 · 자폭적
     * 에서만 들어오므로(돌진 후 사망은 경험치 없음) **잘 잡는 사람일수록 빨라집니다.**
     *
     * 34 는 "4초에 1마리꼴로 잡은 사람"에 맞춘 값입니다. 겁쟁이 1마리 = 경험치 10.8
     * (3 x 1.6 x 2.25) 이라 90초에 22마리면 누적 236 = Lv7 이고, 6번 올라 205 + 204 = 409
     * 로 2배입니다. 회피 봇은 잡으러 다니지 않아 120초에 Lv1 ~ 3 에 머뭅니다
     */
    levelMoveSpeedStep: 34,
    /**
