...
export const CHALLENGE_RULES = {
  ...
  blackout: {
     ...
     *
     * **1분입니다** (2026-09-17 사용자 지시). 같은 날 5초에서 올렸습니다.
     *
     * 5초일 때는 나오자마자 전부 달려들어서, 어둠에 무엇이 숨어 있는가가 아니라
     * 계속 밀려오는 것을 쳐내는 판이었습니다. 1분이면 **어둠 어딘가에서 조용히
     * 익어가는 적**이 됩니다. 돌진 후 사망이 없어졌으므로(결정 26) 그 사이 겁쟁이는
     * 계속 쌓이고, 인내가 끝나는 순간이 한꺼번에 몰려옵니다
     */
    cowardPatience: 60,
    /**
