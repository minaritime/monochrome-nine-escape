...
export const CHALLENGE_RULES = {
  ...
  blackout: {
    ...
    bomberAliveMax: 16,
    /**
     * **자폭적은 어둠 속 아무 데나 나옵니다** (2026-09-19 사용자 지시).
     *
     * 어둠 속에서는 안 움직이므로 가장자리에서 내면 판 내내 벽에 붙어 있습니다.
     * 시야 테두리에서 이만큼 더 떨어진 자리에만 냅니다. 한 걸음에 드러나는 자리에
     * 튀어나오면 "숨어 있던 것을 밟았다"가 아니라 "눈앞에 생겼다"가 됩니다
     */
    bomberSpawnMargin: 80,
    /**
