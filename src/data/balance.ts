...
export const CHALLENGE_RULES = {
  ...
  shieldMarch: {
     ...
     * 동시에 상한(5 · 15)에 닿고**, 남은 40초는 그 밀도를 유지한 채 버팁니다.
     *
     * 앞 절반은 조여오고 뒤 절반은 최대치에서 버티는 모양입니다. 끝까지 계속
     * 늘어나게 하려면 이 간격을 7.5 초로 늘리면 클리어 시점에 상한에 닿습니다
     */
    spawnStep: 5,
    /**
...
export const CHALLENGE_STAGES: readonly ChallengeStageDef[] = [
  {
    id: 'shieldMarch',
    name: '방패 행진',
    // 3분에서 2분으로 줄였습니다 (2026-09-16 사용자 지시)
    clearTime: 120,
