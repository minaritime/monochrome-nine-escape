...
export const CHALLENGE_RULES = {
  ...
  summoner: {
    ...
    killsPerLevelStep: 3,
    /**
     * **늦게 나오는 소환사는 하수인을 데리고 나옵니다** (2026-09-23 사용자 결정).
     *
     * 판이 이 시간(초)만큼 흐를 때마다 등장할 때 미리 부르는 횟수가 1씩 늡니다
     * (45초 1번, 90초 2번, 135초 3번). 새 소환사가 빈손으로 나오면 빨리 잡을수록
     * 화면이 비어서, 강해진 뒤에는 하수인이 쌓일 틈이 없었습니다.
     * 바보적은 한 번에 둘로 쪼개지므로 몸은 두 배입니다
     */
    premadeMinionStep: 45,
    premadeMinionMax: 3,
    /**
