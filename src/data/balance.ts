...
export const SKILL_BRANCHES = {
  ...
  ricochet: [
    ...
    },
    {
      ...
      // **한 번만 갈라집니다** (2026-09-10 사용자 확정). 미사일과 같은 규칙이라
      // "분열 갈래는 한 번만"이 이 게임의 규칙이 됐습니다.
      //
      // 예전에는 4세대라 탄이 **31발**이 되고, 그 31발이 각자 명중 횟수를 다 들고
      // 나가서 한 번 발사에 **217타**였습니다. 도탄은 미사일과 달리 곱셈 축이
      // 하나 더 있습니다. 갈라진 자식이 `pierce` 를 그대로 복사하므로
      // **(탄 수) x (명중 횟수)** 가 되고, 수명이 무한이라 그 타격이 사실상 확정입니다
      splitOnHit: { count: 2, generations: 1 },
