...
export const CHALLENGE_RULES = {
  ...
  blackout: {
     ...
     *
     * **0.6마리/초입니다** (2026-09-20 사용자 지시, 5초당 2 → 3마리). 2026-09-17 의
     * "초당 3마리 누적"(30초에 60마리)과는 이름만 비슷하고 5배 낮습니다.
     *
     * ⚠ **겁쟁이가 스스로 사라지는 길이 없습니다** (같은 날 돌진 후 사망 삭제).
     * 잡지 않으면 그대로 쌓입니다. 이 값이 곧 "내가 따라가야 하는 처리량"이고,
     * 120초 동안 72마리라 **4마리를 잡을 때마다 6.7초**가 주어지는 셈입니다
     */
    cowardSpawnStep: 5,
    cowardSpawnCount: 3,
    /**
