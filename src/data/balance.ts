...
export const CHALLENGE_RULES = {
  ...
  blackout: {
    ...
    darkColor: '#05070b',
    /**
     * **종류별 동시 상한. 판이 갈수록 늘어납니다** (2026-09-19 사용자 지시).
     *
     * 죽은 만큼 곧바로 다시 채우고, 상한에 닿아 있으면 안 냅니다. 처음 값에서 시작해
     * 클리어 시간에 끝 값에 닿도록 곧게 늘어납니다.
     *
     * 2026-09-17 의 "초당 3마리 누적"을 되돌린 자리입니다. 그 방식은 밀도가 내 처리량이
     * 아니라 시계로 정해져서 30초에 상한 60 에 닿았고, 시야 안에 늘 8 ~ 12 마리가
     * 있었습니다. "어둠에서 하나가 온다"가 아니라 "어둠이 밀려온다"였습니다.
     *
     * **종류마다 따로 둡니다.** 합쳐서 하나로 두면 오래 사는 겁쟁이가 칸을 독점해
     * 자폭적이 화면에서 사라집니다 (결정 27 의 ⚠).
     *
     * ⚠ 초안입니다. 자폭적 16 은 어둠 속에 고르게 깔리면 시야(경기장의 9.3%) 안에
     * 1.5 마리쯤 걸리는 값입니다
     */
    cowardAliveStart: 6,
    cowardAliveMax: 14,
