...
export const CHALLENGE_RULES = {
  ...
  blackout: {
     ...
     *
     * 40 이면 시야 165 기준 205 에서 출발합니다. 돌진은 720px/s 로 0.8초라 576px 를 가서
     * 충분히 닿습니다
     */
    cowardDashMargin: 40,
    /**
     ...
     *
     * **3배입니다** (2026-09-19 사용자 지시, 2배에서 올림). 240 x 3 = 720px/s 라
     * 시야 테두리(165)에서 몸에 닿기까지 0.2초 남짓입니다. 보고 피하기보다 **예상하고
     * 피하는** 속도입니다.
     *
     * **이 판에서만입니다.** 일반 게임의 겁쟁이(인내 30초)는 그대로입니다
     */
    cowardEnragedDashMul: 3,
    /**
