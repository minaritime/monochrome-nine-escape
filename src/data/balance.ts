...
export const CHALLENGE_RULES = {
  ...
  blackout: {
     ...
     *
     * 2026-09-17 의 "초당 3마리 누적"과는 다릅니다. 그때는 0.4마리/초의 7.5배였고
     * 30초에 60마리에 닿았습니다. 지금은 **0.4마리/초**입니다. 겁쟁이는 각성(20초)
     * 뒤 돌진하면 사라지므로, 안 잡고 버티기만 해도 10 ~ 14 마리 언저리에서 멈춥니다.
     * 그 위는 전부 "내가 잡지 못해 쌓인 몫"입니다
     */
    cowardSpawnStep: 5,
    cowardSpawnCount: 2,
    /**
