...
export const CHALLENGE_RULES = {
  ...
  blackout: {
     ...
     *
     * 원문은 "시야에 보이지 않는 한에서 충분히 가까워지면 돌진"입니다. 그래서 돌진은
     * 반드시 **어둠 속에서** 시작합니다. 시야 안에 들어온 각성 겁쟁이는 돌진하지 않고
     * 계속 걸어오므로 그때는 잡을 수 있습니다.
     *
     * **20 입니다** (2026-09-20 사용자 지시, 40 에서 줄임). 시야 165 기준 185 에서
     * 출발합니다. 어둠에 잠긴 띠가 20px 로 얇아져서, 각성한 겁쟁이는 **거의 시야
     * 테두리까지 걸어 들어온 뒤에 달립니다.** 보이기 직전까지 다가오므로 나오는
     * 자리를 좁혀 읽을 수 있고, 돌진이 지나는 거리도 그만큼 짧아집니다
     */
    cowardDashMargin: 20,
    /**
